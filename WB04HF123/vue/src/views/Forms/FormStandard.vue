                ...
                <form>
                    <div class="form-row align-items-center">
                        <div class="col-auto">
                            ...
                            <input class="form-control mb-2" id="inlineFormInput" type="text" placeholder="Jane Doe" />
                        </div>
                        <div class="col-auto">
                    ...
                    <fieldset>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <b-form-group>
                                    <b-input-group>
                                      <b-dropdown text="Dropdown" variant="info" slot="prepend">
                                ...
                                <b-form-group>
                                    <b-input-group>
                                      <b-form-input></b-form-input>
                                      <b-dropdown text="Dropdown" split variant="outline-secondary" slot="append">
