            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card b">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <em class="fa fa-times fa-fw text-warning mr-2"></em>
                        ...
                        <div class="card-body text-center">
                            <a class="btn btn-secondary btn-lg" href="">Select this plan</a>
                        </div>
                    </div>
                </div>
                <!-- PLAN-->
                <div class="col-lg-4">
                    <div class="card b">
                        ...
                        <div class="card-body text-center">
                            <a class="btn btn-danger btn-lg" href="">Select this plan</a>
                        </div>
                    </div>
                </div>
                <!-- PLAN-->
