                    ...
                    <div class="card b">
                        ...
                        <div class="list-group">
                            <a class="list-group-item list-group-item-action"
                                href="#"
                                :class="this.activeTab === 'profile' ? 'active':''"
                                @click="toggleTab('profile')">Profile</a>
                            <a class="list-group-item list-group-item-action"
                                href="#"
                                :class="this.activeTab === 'account' ? 'active':''"
                                @click="toggleTab('account')">Account</a>
                            <a class="list-group-item list-group-item-action"
                                href="#"
                                :class="this.activeTab === 'emails' ? 'active':''"
                                @click="toggleTab('emails')">Emails</a>
                            <a class="list-group-item list-group-item-action"
                                href="#"
                                :class="this.activeTab === 'notifications' ? 'active':''"
                                @click="toggleTab('notifications')">Notifications</a>
                            <a class="list-group-item list-group-item-action"
                                href="#"
                                :class="this.activeTab === 'applications' ? 'active':''"
                                @click="toggleTab('applications')">Applications</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div v-show="this.activeTab == 'profile'">
                        <div class="card b">
                    ...
                    <div v-show="this.activeTab == 'account'">
                        <div class="card b">
                    ...
                    <div v-show="this.activeTab == 'emails'">
                        <div class="card b">
                            <div class="card-header bg-gray-lighter text-bold">Emails</div>
                            <div class="card-body">
                                <p>Etiam eros nibh, condimentum in auctor et, aliquam quis elit. Donec id libero eros. Ut fringilla, justo id fringilla pretium, nibh nunc suscipit mauris, et suscipit nulla nisl ac dolor. Nam egestas, leo eu gravida tincidunt,
                                    sem ipsum pellentesque quam, vel iaculis est quam et eros.</p>
                                <p>
                                    <strong>Your email addresses</strong>
                                </p>
                                <p>
                                    <span class="mr-2">email@someaddress.com</span>
                                    <span class="badge badge-success">primary</span>
                                </p>
                                <p>
                                    <span class="mr-2">another.email@someaddress.com</span>
                                    <span class="badge bg-gray">private</span>
                                </p>
                            </div>
                            <div class="card-body bt">
                                <p>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label">Keep my email address private</label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div v-show="this.activeTab == 'notifications'">
                        <form action="#">
                            <div class="card b">
                                <div class="card-header bg-gray-lighter text-bold">Notifications</div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label">Alert me when someone start to follow me</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" id="defaultCheck4" type="checkbox" value="" />
                                        <label class="form-check-label">Alert me when someone star my work</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" id="defaultCheck5" type="checkbox" value="" />
                                        <label class="form-check-label">Alert me when post a new comment</label>
                                    </div>
                                    <p class="my-2">
                                    ...
                                    <div class="form-check mb-2">
                                        ...
                                        <label class="form-check-label">Send me news and interesting updates</label>
                                    </div>
                                    <button class="mb-3 btn btn-info" type="button">Update notifications</button>
                                    <p>
                    ...
                    <div v-show="this.activeTab == 'applications'">
                        <div class="card b">
