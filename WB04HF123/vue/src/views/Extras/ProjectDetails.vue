        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card b">
                    ...
                    <div class="card-body bb bt">
                        <a class="inline" href="#" data-toggle="tooltip" data-title="Team leader">
                            <img class="rounded-circle thumb48" src="img/user/03.jpg" alt="project member" />
                        </a>
                        <a class="inline" href="#">
                        ...
                        <a class="inline" href="#">
                            <img class="rounded-circle thumb24" src="img/user/07.jpg" alt="project member" />
                        </a>
                        <a class="inline" href="#">
                            <img class="rounded-circle thumb24" src="img/user/08.jpg" alt="project member" />
                        </a>
                        <a class="inline" href="#">
                            <img class="rounded-circle thumb24" src="img/user/09.jpg" alt="project member" />
                        </a>
                        <div class="float-right mt-2">
                            <button class="btn btn-secondary" type="button">Add Member</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <h4>Description</h4>
            ...
            <div class="col-xl-4">
                ...
                <div class="card b">
                    ...
                    <div class="card-body">
                        <ul class="list-inline my-2">
                            <li class="list-inline-item">
                                <div class="badge p-1 bg-warning">priority</div>
                            </li>
                            <li class="list-inline-item">
                                <div class="badge p-1 bg-gray">angularjs</div>
                            </li>
                            <li class="list-inline-item">
                                <div class="badge p-1 bg-gray">jquery</div>
                            </li>
                            <li class="list-inline-item">
                                <div class="badge p-1 bg-gray">gulp</div>
                            </li>
                            <li class="list-inline-item">
                                <div class="badge p-1 bg-gray">git</div>
                            </li>
                            <li class="list-inline-item">
                                <div class="badge p-1 bg-gray">ios</div>
                            </li>
                        </ul>
                    </div>
                    <table class="table">
                                        ...
                                        <div class="list-group">
                                            <table class="table table-bordered bg-transparent">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <em class="fa-lg far fa-file-code"></em>
                                                        </td>
                                                        <td>
                                                            <a class="text-muted" href="#">database.controller.js</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <em class="fa-lg far fa-file-image"></em>
                                                        </td>
                                                        <td>
                                                            <a class="text-muted" href="#">baground-lg.png</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a class="text-muted" href="#">picture.controller.js</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <em class="fa-lg far fa-file-word"></em>
                                                        </td>
                                                        <td>
                                                            <a class="text-muted" href="#">applicat-diagrams.docx</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                    ...
                    <p class="text-right">
                        <a class="btn btn-link" href="#">Open repository</a>
                    </p>
                </div>
                <!-- end Aside card-->
            </div>
