<template>
    <ContentWrapper>
        <div class="content-heading">
            ...
            <div class="ml-auto">
                <div class="d-flex align-items-center">
                    <small class="mr-2">Single column</small>
                    <label class="switch m-0">
                        <input type="checkbox" v-model="timelineAlt" />
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <!-- START timeline-->
        <!-- ul.timeline-alt-->
        <ul :class="timelineAlt ? 'timeline-alt' : 'timeline'">
                ...
                <div class="timeline-card">
                    <div class="popover right">
                        ...
                        <div class="popover-body">
                            ...
                            <div class="btn-group">
                                <div class="dropdown-toggle" data-toggle="dropdown" data-play="fadeIn">
                                    <em class="fa fa-paperclip"></em>
                                </div>
                                <div class="dropdown-menu text-left">
                                    <div class="dropdown-item">
                                        <em class="fa fa-download mr-2"></em> Download</div>
                                    <div class="dropdown-item">
                                        <em class="fa fa-share mr-2"></em> Send to</div>
                                    <div class="divider"></div>
                                    <div class="dropdown-item">
                                        <em class="fa fa-times mr-2"></em> Delete</div>
                                </div>
                            </div>
                        </div>
                    </div>
