            ...
            <div class="col-xl-3 col-lg-4">
                <div class="d-flex mb-2">
                    <a class="btn btn-purple btn-sm mb-compose-button" href="#">
                        <em class="fas fa-pencil-alt mr-1"></em>
                        <span>Compose</span>
                    </a>
                    <button class="btn btn-sm btn-secondary mb-toggle-button ml-auto" type="button" v-b-toggle.mbboxes>
                        <em class="fa fa-bars fa-fw fa-lg"></em>
                    </button>
                </div>
                <!-- START mailbox list-->
                <b-collapse class="mb-boxes collapse show" id="mbboxes" visible>
                ...
                <div class="d-flex mb-2">
                    <div class="btn-group">
                        <button class="btn btn-secondary btn-sm" type="button">
                            <em class="fas fa-reply text-gray-dark"></em>
                        </button>
                        <button class="btn btn-secondary btn-sm" type="button">
                            <em class="fas fa-reply-all text-gray-dark"></em>
                        </button>
                        <button class="btn btn-secondary btn-sm" type="button">
                            <em class="fas fa-share text-gray-dark"></em>
                        </button>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <em class="fa-lg far fa-star text-muted"></em>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <em class="fa-lg fa fa-star text-warning"></em>
                                    </td>
                                    <td>
                                        <div class="d-flex">
