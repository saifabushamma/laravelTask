        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="card card-default d-none d-lg-block">
                    ...
                    <div class="card-body">
                        <div class="media">
                            <img class="align-self-center mr-2 rounded-circle img-thumbnail thumb48" src="img/user/04.jpg" alt="Contact" />
                ...
                <div class="card card-default">
                    <div class="card-header d-flex align-items-center">
                        <div class="d-flex justify-content-center col">
                            <div class="h4 m-0 text-center">Contact Information</div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <b-dropdown id="ddown1" variant="link" no-caret right>
                                ...
                                <b-dropdown-item>Send by message</b-dropdown-item>
                                <b-dropdown-item>Share contact</b-dropdown-item>
                        ...
                        <div class="row py-4 justify-content-center">
                            <div class="col-12 col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-10 col-md-9 col-8">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck1">Favorite contact?</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="text-right">
                                    <a class="text-muted" href="#">Delete this contact?</a>
                                </div>
                            </div>
                        </div>
                    </div>
