    ...
    <ContentWrapper>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <Datatable :options="dtOptions2" class="table table-striped my-4 w-100" id="datatable2">
                        <thead>
                            <tr>
                                <th data-priority="1">Engine</th>
                                <th>Browser</th>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <Datatable :options="dtOptions3" class="table table-striped my-4 w-100" id="datatable3">
                        <thead>
                            <tr>
                                <th data-priority="1">Engine</th>
                                <th>Browser</th>
